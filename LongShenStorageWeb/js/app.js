...
async function loadDeviceMonitor() {
    try {
        ...
        const allRegs = [
            ...
            {a:4010,n:'故障代码(高)',v:st.errorCode,d:''},{a:4011,n:'故障代码(低)',v:st.errorCodeLow ?? 0,d:''},
            {a:4012,n:'运行模式',v:st.mode,d:'1手动 2自动'},{a:4013,n:'动作步骤',v:st.step,d:''},
            {a:4014,n:'任务完成',v:fl.taskDone,d:'1完成 2执行'},{a:4015,n:'转移状态',v:fl.transferState,d:'1未取 2已转 3到位'},
            {a:4016,n:'备用',v:fl.spare ?? 0,d:''},{a:4017,n:'X轴位置',v:pos.x,d:'mm'},
            {a:4018,n:'Y轴位置',v:pos.y,d:'mm'},{a:4019,n:'Z深库',v:pos.zDeep,d:'mm'},
            {a:4020,n:'Z浅库',v:pos.zShallow,d:'mm'},{a:4021,n:'可移库',v:data.canMove ?? 0,d:'1可 2不可'},
            {a:4022,n:'左入可入库',v:fl.leftIn,d:'1可 2不可'},{a:4023,n:'左出可出库',v:fl.leftOut,d:'1可 2不可'},
            {a:4024,n:'右入可入库',v:fl.rightIn,d:'1可 2不可'},{a:4025,n:'右出可出库',v:fl.rightOut,d:'1可 2不可'},
            {a:4026,n:'A→B完成',v:fl.actionDone,d:'0/1'},{a:4027,n:'堆垛车位置',v:fl.carrierPos,d:'车位号'},
            {a:2022,n:'设备序号',v:data.deviceNo ?? 0,d:'写入区'},
